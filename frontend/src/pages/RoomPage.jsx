...
//     socket.emit('emoji-reaction', { userId: socket.id, emoji });
//     setEmojis(prev => ({
//       ...prev,
...
//       socket.emit('join-room', { roomId, userId: socket.id, name: myName });
...
//       socket.on('user-signal', ({ callerId, signal, name }) => {
//         const peer = new Peer({
//           initiator: false,
//           trickle: false,
//           stream: currentStream,
...
//       socket.on('received-return-signal', ({ signal, id }) => {
...
//               />
//               {emojis['me'] && (
//                 <div className="absolute top-1 left-1 text-3xl animate-bounce">{emojis['me'].emoji}</div>
//               )}
...
//                   <div className="absolute top-1 left-1 text-3xl animate-bounce">
...
//   const sendEmoji = (emoji) => {
//     const audio = new Audio('/sounds/pop.mp3'); // Optional: create public/sounds/pop.mp3
//     audio.play();
...
//     // Replace the video track for each peer
//     peersRef.current.forEach(({ peer }) => {
...
//     screenTrack.onended = () => {
//       // Replace with original webcam video
...
//       // Replace local preview with screen
//       if (myVideo.current) {
