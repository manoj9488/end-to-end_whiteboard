...
//   return (
//     <motion.div
//       className={`bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-3xl shadow-2xl border border-purple-500/20 backdrop-blur-sm ${
//         isExpanded ? "fixed inset-4 z-50" : "w-full h-96"
//       }`}
...
//         <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl p-6 border border-slate-700/50 shadow-inner">
//           {/* Tools Section */}
//           <div className="mb-6">
...
//               style={{ height: isExpanded ? "calc(100vh - 400px)" : "300px" }}
...
//         isExpanded ? "fixed inset-4 z-50 w-auto h-auto max-w-none max-h-none" : "w-full h-auto"
//       }`}
//       initial={{ opacity: 0, scale: 0.9, y: 20 }}
//       animate={{ opacity: 1, scale: 1, y: 0 }}
//       exit={{ opacity: 0, scale: 0.9, y: 20 }}
...
//               ref={canvasRef}
//               className="w-full bg-white cursor-crosshair"
//               style={{ height: isExpanded ? "calc(100vh - 300px)" : "300px" }}
//               onMouseDown={startDrawing}
//               onMouseMove={draw}
//               onMouseUp={stopDrawing}
//               onMouseLeave={stopDrawing}
